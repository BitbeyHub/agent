...
You can also run the Agent in a docker container, but some of the examples rely on navigating the local filesystem, so exact locations may vary. If you choose to run the Agent in a container, you will need to modify the examples to use the correct paths.
